...
const uint8_t ref_crc8_init = 0xff;
const uint8_t ref_crc8_tab[256] =
{
...
const uint16_t ref_crc16_init = 0xffff;
const uint16_t ref_crc16_tab[256] =
    {
...
//校验crc8数据
uint32_t ref_verify_crc8(uint8_t *p_msg, unsigned int len)
{
