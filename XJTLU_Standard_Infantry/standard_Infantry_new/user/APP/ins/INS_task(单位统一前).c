...
static volatile fp32 INS_quat[4] = {1.0f, 0.0f, 0.0f, 0.0f}; //四元数
...
void IMU_AHRSupdate(void) {
    ...
    gx = mpu6500_real_data.gyro[0] * PI/180;
    gy = mpu6500_real_data.gyro[1] * PI/180;
    gz = mpu6500_real_data.gyro[2] * PI/180;
