...
//底盘旋转跟随PID
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 11.0f							//50				//10			//25			//20
#define CHASSIS_FOLLOW_GIMBAL_PID_KI 0.0f							//5					//15			//20			//40
#define CHASSIS_FOLLOW_GIMBAL_PID_KD 0.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_OUT 30.0f				//30
...
typedef enum
{
  ...
  CHASSIS_VECTOR_NO_FOLLOW_YAW,
	CHASSIS_VECTOR_NO_FOLLOW_YAW_SPINNING,
  CHASSIS_VECTOR_RAW,
...
typedef struct
{
  ...
  const fp32 *chassis_INS_angle;             //获取陀螺仪解算出的欧拉角指针
	super_cap_t *super_cap_data;  //获取超级电容状态指针
  refree_system_t *refree_system;			 //获取裁判系统数据指针
...
extern uint16_t chassis_spinning_finished;
