...
#define YAW_SPEED_PID_KP 2200.0f							//90
...
#define PITCH_GYRO_ABSOLUTE_PID_KP 50.0f   //25
...
#define YAW_GYRO_ABSOLUTE_PID_KP 60.0f
...
#define PITCH_ENCODE_RELATIVE_PID_KP 70.0f
...
#define YAW_ENCODE_RELATIVE_PID_KP 60.0f							//8.0
#define YAW_ENCODE_RELATIVE_PID_KI 0.0f
#define YAW_ENCODE_RELATIVE_PID_KD 0.0f
#define YAW_ENCODE_RELATIVE_PID_MAX_OUT 50.0f
...
#define Pitch_Mouse_Sen 0.000037593984962406f
//云台编码器控制时候使用的比例
...
//自瞄增量系数
#define GIMBAL_PITCH_VISION_ADD_SEN 0.001f
#define GIMBAL_YAW_VISION_ADD_SEN 0.001f
...
typedef struct
{
    const RC_ctrl_t *gimbal_rc_ctrl;
		const vision_receive_t *vision_receive_ctrl;
