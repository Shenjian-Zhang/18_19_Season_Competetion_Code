...
//            }
    ...
    else
    {
		...
		if(gimbal_behaviour == GIMBAL_INIT)
		{
				gimbal_mode_set->gimbal_yaw_motor.min_relative_angle = -0.5f;
				gimbal_mode_set->gimbal_yaw_motor.max_relative_angle = 0.5f;
		}
		else
		{
				gimbal_mode_set->gimbal_yaw_motor.min_relative_angle = 0.0f;
				gimbal_mode_set->gimbal_yaw_motor.max_relative_angle = 0.0f;
		}
}
