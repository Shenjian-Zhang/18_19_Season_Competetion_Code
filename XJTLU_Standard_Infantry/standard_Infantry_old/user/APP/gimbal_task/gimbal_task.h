...
#define PITCH_SPEED_PID_MAX_OUT 700.0f
#define PITCH_SPEED_PID_MAX_IOUT 0.0f

//yaw 速度环 PID参数以及 PID最大输出，积分输出
#define YAW_SPEED_PID_KP 90.0f							//90	2200
#define YAW_SPEED_PID_KI 0.0f
#define YAW_SPEED_PID_KD 0.0f
#define YAW_SPEED_PID_MAX_OUT 300.0f					//30000.0
#define YAW_SPEED_PID_MAX_IOUT 0.0f

//pitch 角度环 角度由陀螺仪解算 PID参数以及 PID最大输出，积分输出
#define PITCH_GYRO_ABSOLUTE_PID_KP 20.0f   //25
...
#define YAW_GYRO_ABSOLUTE_PID_KP 40.0f
