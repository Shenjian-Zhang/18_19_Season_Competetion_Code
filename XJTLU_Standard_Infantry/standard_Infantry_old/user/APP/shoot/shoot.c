...
//    ramp_init(&trigger_motor.fric1_ramp, SHOOT_CONTROL_TIME * 0.001f, Fric_OFF, Fric_UP);
//    ramp_init(&trigger_motor.fric2_ramp, SHOOT_CONTROL_TIME * 0.001f, Fric_OFF, Fric_UP);
...
static void shoot_bullet_control(void)
{
    ...
    {
        trigger_motor.set_angle = rad_format(trigger_motor.set_angle + PI_Dotfour);
