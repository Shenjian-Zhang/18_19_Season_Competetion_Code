...
{
		gimbal_control.gimbal_pitch_motor.max_relative_angle = 0.4f;
		gimbal_control.gimbal_pitch_motor.min_relative_angle = -0.15f;
		gimbal_control.gimbal_yaw_motor.max_relative_angle = 0.8f;
		gimbal_control.gimbal_yaw_motor.min_relative_angle = -0.8f;
...
//    ECD_Format(temp_ecd);
    *yaw_offset = gimbal_control.gimbal_yaw_motor.gimbal_motor_measure->ecd;
    *max_yaw = motor_ecd_to_angle_change(gimbal_cali->max_yaw_ecd, *yaw_offset);
    *min_yaw = motor_ecd_to_angle_change(gimbal_cali->min_yaw_ecd, *yaw_offset);
...
//    ECD_Format(temp_ecd);
    *pitch_offset = gimbal_control.gimbal_pitch_motor.gimbal_motor_measure->ecd;
    *max_pitch = motor_ecd_to_angle_change(gimbal_cali->max_pitch_ecd, *pitch_offset);
    *min_pitch = motor_ecd_to_angle_change(gimbal_cali->min_pitch_ecd, *pitch_offset);
#endif
}
