...
//	pid[PITCH_SPEED].f_pid_init(&pid[PITCH_SPEED], 290.0f, 1.0f, 80.0f, 30000.0f, 1000.0f, 10000.0f, 30000.0f);
	pid[PITCH_SPEED].f_pid_init(&pid[PITCH_SPEED], 20.0f, 0.0f, 0.0f, 5000.0f, 100.0f, 1000.0f, 5000.0f);
	...
	pid[YAW_SPEED].f_pid_init(&pid[YAW_SPEED], 100.0f, 0.0f, 0.0f, 30000.0f, 1000.0f, 10000.0f, 30000.0f);
//	pid[YAW_SPEED].f_pid_init(&pid[YAW_SPEED], 80.0f, 0.0f, 0.0f, 30000.0f, 1000.0f, 10000.0f, 30000.0f);
	
	pid[CHASSIS_FOLLOW].f_pid_init = pid_init;
	pid[CHASSIS_FOLLOW].f_pid_init(&pid[CHASSIS_FOLLOW], 15.0f, 1.0f, 300.0f, 800.0f, 0.0f, 0.0f, 800.0f);
//	pid[CHASSIS_FOLLOW].f_pid_init(&pid[CHASSIS_FOLLOW], 15.0f, 0.0f, 0.0f, 500.0f, 0.0f, 500.0f, 500.0f);
	...
	pid[VISUAL_YAW_OFFSET].f_pid_init(&pid[VISUAL_YAW_OFFSET], 0.0075f, 0.0005f, 0.00001f, 1.5f, 0.0f, 0.2f, 1.7f);
	
	pid[VISUAL_PITCH_OFFSET].f_pid_init = pid_init;
	pid[VISUAL_PITCH_OFFSET].f_pid_init(&pid[VISUAL_PITCH_OFFSET], 0.001f, 0.0005f, 0.0001f, 1.5f, 0.0f, 0.2f, 1.7f);
